...
do
    ...
    do
        ...
        webAppTagCategory=($(echo "$webAppSummary" | jq '.[].tags.bsr[0].category')) && webAppTagCategory=("${webAppTagCategory[@]//\"/}")
        webAppTagValue=($(echo "$webAppSummary" |jq '.[].tags.bsr[0].value')) && webAppTagValue=("${webAppTagValue[@]//\"/}")
        ...
        do
            ...
            milestoneName=($( jq -r '.['$w'].userFlow.milestones[] | @sh | sub(" "; "_";"g")' /data/webAppSummary_"$l".json)) && milestoneName=(${milestoneName[@]//\'/})
